...
# Returns list
def extract_apk(aapt, package_path, backup_dir, md5_dict):
...
for _i in _purged_packages:
	_nemris_config["md5_dict"] = extract_apk(_nemris_config.get("aapt"), _optimized_dict.get(_i), _nemris_config.get("backup_dir"), _nemris_config.get("md5_dict"))
